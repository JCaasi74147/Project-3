...
Potential issues:
* ensure that actor-movie-data.zip is unzipped;
  the batch/shell files should take care of this automatically.
  if not, the resultant file 'actor-movie-data.csv'
